...
public class LocalToPmaProdConfigurationProvider implements ConfigurationProvider {
  ...
  public Collection<KeyValue> create(Map<ConfigurationKey, KeyValue> defaultConfiguration) {
    ...
    override(defaultConfiguration, ConfigurationKey.PRODUCTION_MODE, Boolean.TRUE.toString());
    ...
    override(
        ...
        "https://api-eu.dhl.com/post/advertising/print-mailing");
    override(
        defaultConfiguration,
        ConfigurationKey.PMA_REDIRECT_FRONTEND_BASE_URL,
        "https://print-mailing.deutschepost.de");
